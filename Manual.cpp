...
Manual::Manual(std::string device_name, std::string manual_url, bool visual_aid):Book(title, author, page_count, is_digital), device_name_(device_name), manual_url_(manual_url), visual_aid_(visual_aid)
{
}
